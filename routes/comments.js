module.exports = {
    ...
    updateComment(req, res) {
        let updatedComment = {text: req.body.text}
        req.store.posts[req.params.postId].comments[req.params.commentId] =  Object.assign(req.store.posts[req.params.postId].comments[req.params.commentId] , updatedComment)
